...
public class ReadExactPatients {
...
// Leer archivo JSON con pacientes
       // JsonArray patientsData = JsonParser.parseReader(new FileReader(Paths.get("readSimilarPatients.json").toFile())).getAsJsonArray();
        ...
        for (int i = 0; i < 1; i++) {
            ...
            readExactPatients(URL + REQUEST_API, httpClient, patientData, sessionId, totp.generarCodigo(token.getBytes()));
        }
    ...
    private static void readExactPatients(String url, HttpClient httpClient, JsonObject patientData, String sessionId, String OTP) throws Exception {
        ...
        data.addProperty("typeOfOperation", "readExactPatients");
