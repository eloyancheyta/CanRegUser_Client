...
//
    ...
    public static void main(String[] args) throws Exception {
        ...
        readPatientByID(URL + REQUEST_API, httpClient, PatientID, sessionId, totp.generarCodigo(token.getBytes()));
    ...
    private static void readPatientByID(String url, HttpClient httpClient, String  PatientID, String sessionId, String OTP) throws Exception {
        ...
        dataPayload.addProperty("PatientID", PatientID);
        //dataPayload.add("patient", patientData);

        JsonObject data = new JsonObject();
        // data.addProperty("typeOfOperation", "savePatient");
        data.addProperty("typeOfOperation", "readPatientByID");
