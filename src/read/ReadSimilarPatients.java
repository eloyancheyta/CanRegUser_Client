...
public class ReadSimilarPatients {
...
//b0901c14d76501054d960ed6942413eda901a5b399c4827288246674ba70e799
    ...
    public static void main(String[] args) throws Exception {
        ...
        JsonArray patientsData = JsonParser.parseReader(new FileReader(Paths.get("readSimilarPatients.json").toFile())).getAsJsonArray();
        ...
        for (int i = 0; i < /*patientsData.size()*/ 1; i++) {
            JsonObject patientData = patientsData.get(i).getAsJsonObject().getAsJsonObject("paciente");
            readSimilarPatients(URL + REQUEST_API, httpClient, patientData, sessionId, totp.generarCodigo(token.getBytes()));
        }
    ...
    private static void readSimilarPatients(String url, HttpClient httpClient, JsonObject patientData, String sessionId, String OTP) throws Exception {
        ...
        data.addProperty("typeOfOperation", "readSimilarPatients");
