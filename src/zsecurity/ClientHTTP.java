...
public class ClientHTTP {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ip = "onca.tamps.cinvestav.mx"; 
        
         ip = "rnca.tamps.cinvestav.mx"; 
         
          ip = "muyal.tamps.cinvestav.mx";
          
          ip = "apix.tamps.cinvestav.mx";
        
        // rnca.tamps.cinvestav.mx
        // muyal.tamps.cinvestav.mx
       // port = "443";
       
        URL = "https://" + ip + "/canreg/api/"+ loginAPI ;
        
        // URL = "http://" + ip + "/canreg/api/"+ loginAPI ;
        ...
        if (codigo == 200) {
            ...
            URL = "https://" + ip + "/canreg/api/" + request;
